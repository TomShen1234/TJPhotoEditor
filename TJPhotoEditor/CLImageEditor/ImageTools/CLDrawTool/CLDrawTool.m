...
- (void)setup
{
    ...
    if (@available(iOS 11.0, *)) {
        // Fix smart invert
        _strokePreview.accessibilityIgnoresInvertColors = YES;
        _strokePreviewBackground.accessibilityIgnoresInvertColors = YES;
        _eraserIcon.accessibilityIgnoresInvertColors = YES;
        _widthSlider.accessibilityIgnoresInvertColors = YES;
    }
